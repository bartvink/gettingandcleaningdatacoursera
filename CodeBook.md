...
#### Assigned and worked on variables
...
#### Tidy Data - The final data 

The output data is stored in `tidy.txt` It contains the mean and standard deviation values of the data contained in the input files.